...
export const GET: APIRoute = async ({ params }) => {
  ...
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
    ...
    <rect width="80" height="630" fill="#166534"/>
    <text x="130" y="90" font-family="Inter, Arial" font-size="34" font-weight="700"><tspan fill="#1a1a1a">Edu</tspan><tspan fill="#166534">buzz</tspan></text>
    ...
    <rect x="130" y="350" width="230" height="48" rx="6" fill="#f0fdf4" stroke="#166534"/>
    <text x="150" y="382" font-family="Inter, Arial" font-size="22" font-weight="500" fill="#166534">${esc(job.category)}</text>
